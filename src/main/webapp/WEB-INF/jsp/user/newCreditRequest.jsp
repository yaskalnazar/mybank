    ...
    <div class="d-flex justify-content-center">
        <div class="col-md-8 col-md-offset-2">
            ...
            <div class="form-group">
                <p>
                    <label><fmt:message key="page.message.credit.limit"/>:<input id="creditLimit" class="form-control" type="number" min="1000" name="creditLimit" required oninput="change()"></label>
                </p>
